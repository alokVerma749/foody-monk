...
const RestaurantMenu = () => {
    ...
    return resInfo === null ? <Shimmer /> : (
        <section>
            ...
            {/* <div
                className="bg-cover bg-no-repeat bg-center h-72 w-full"
                style={{ backgroundImage: `url(${IMG_URL + cloudinaryImageId})` }}
            >
                <h3 className='text-4xl font-medium text-white flex justify-center m-4'>{name}</h3>
            </div> */}
