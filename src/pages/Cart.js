const Cart = ({ name, price, cloudinaryImageId }) => {
    return (
        <div className="flex flex-col mx-auto max-w-3xl p-6 space-y-4 sm:p-10 bg-gray-50 text-gray-800">
                        ...
                        <div className="flex flex-col justify-between w-full pb-4">
                            <div className="flex justify-between w-full pb-2 space-x-2">
                                <div className="space-y-1">
                                    <h3 className="text-lg font-semibold leadi sm:pr-8">Camera</h3>
            ...
            <div className="flex justify-end space-x-4">
                <button type="button" className="px-6 py-2 border rounded-md border-indigo-600">Back
